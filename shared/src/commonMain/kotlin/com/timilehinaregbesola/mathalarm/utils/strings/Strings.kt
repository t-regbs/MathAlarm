...
data class Strings(
    ...
    val whatsNew: String,
    val snoozeAnnouncementTitle: String,
    val snoozeAnnouncementDescription: String,
    val snoozeAnnouncementInstructions: String,
    ...
    val clear: String,
    val snooze: String,
    val snoozeOff: String,
    val allowSnooze: String,
    val snoozeDuration: String,
    val snoozeDurationHint: String,
    val applySnooze: String,
    val snoozeMaximumSummary: (count: Int) -> String,
    val snoozeSettingsSummary: (minutes: Int, limit: String) -> String,
    val maximumSnoozes: String,
    val unlimitedSnoozes: String,
    val noSnoozesLeft: String,
    val snoozesLeft: (count: Int) -> String,
    val snoozeLimitSummary: (count: Int, minutes: Int) -> String,
    val enter: String,
