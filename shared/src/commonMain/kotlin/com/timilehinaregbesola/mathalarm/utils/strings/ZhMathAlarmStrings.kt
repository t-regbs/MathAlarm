...
val ZhMathAlarmStrings = Strings(
    ...
    checkAnswer = "检查答案",
    nextFeature = "下一项",
    snoozeAnnouncementTitle = "自定义稍后提醒",
    snoozeAnnouncementDescription = "设置稍后提醒次数上限，选择 1–30 分钟的间隔，或关闭稍后提醒。新闹钟默认可稍后提醒 3 次，每次 5 分钟。现有闹钟保留原来的次数上限。",
    snoozeAnnouncementInstructions = "使用稍后提醒复选框快速开启或关闭。点击旁边的编辑可更改次数上限和间隔。",
    whatsNew = "新功能",
    ...
    clear = "清除",
    maximumSnoozes = "最多稍后提醒次数",
    unlimitedSnoozes = "不限次数",
    noSnoozesLeft = "稍后提醒次数已用完",
    snoozesLeft = { count -> "还可稍后提醒 $count 次" },
    snoozeLimitSummary = { count, minutes -> "$count 次稍后提醒 · 最多延长 $minutes 分钟" },
    snoozeOff = "关闭",
    allowSnooze = "允许稍后提醒",
    snoozeDuration = "时长（分钟）",
    snoozeDurationHint = "选择 1–30 分钟。 点按数字即可输入。",
    applySnooze = "应用稍后提醒设置",
    snoozeMaximumSummary = { count -> "最多 $count 次" },
    snoozeSettingsSummary = { minutes, limit -> "$minutes 分钟 · $limit" },
    snooze = "贪睡",
    enter = "输入",
