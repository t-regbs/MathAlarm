...
//        val alarmId = extra!![ALARM_EXTRA] as Long
        ...
        alarmMathViewModel = ViewModelProviders.of(
...
//            alarmMathViewModel.onUpdate(alarmMathViewModel.alarmm.value!!)
    ...
    private fun showCalc(args: AlarmMathFragmentArgs) {
        ...
        binding.mathBtnSet.setOnClickListener(View.OnClickListener {
            if (sb.toString().toInt() != ans) {
                ...
                if (args.type == "TEST"){
                    ...
                    findNavController().navigate(
                        AlarmMathFragmentDirections.actionAlarmMathFragmentToAlarmFragment())
                }
...
//                requireActivity().finish()
        ...
        binding.mathBtnSnooze.setOnClickListener(View.OnClickListener {
            if (alarmMathViewModel.alarmm.value!!.snooze == 0) {
                Toast.makeText(
                    activity,
                ...
                mp.stop()
                vibrateRunning = false
                scheduleSnooze(requireContext(), alarmMathViewModel.alarmm.value!!)
                requireActivity().finish()
            }
        })
    }
